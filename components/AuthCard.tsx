...
export function AuthCard({ mode }: { mode: "signup" | "signin" }) {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-1">
      ...
      <button type="button" onClick={google} className="mt-8 flex w-full items-center justify-center gap-3 rounded-full border border-[#d7d7d2] py-3 text-sm font-medium">
